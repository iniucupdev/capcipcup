...
<head>
  ...
  <title>Halmahera Timur | Data /title>
      ...
      <ul class="sidebar-menu">
        ...
        <li>
          <a href="<?php echo base_url().'admin/pegawai'?>">
            <i class="fa fa-graduation-cap"></i> <span>Data pegawai</span>
            <span class="pull-right-container">
              <small class="label pull-right"></small>
            </span>
          </a>
        ...
        <li class="treeview active">
          ...
          <ul class="treeview-menu">
            <li class="active"><a href="<?php echo base_url().'admin/siswa'?>"><i class="fa fa-users"></i> Data </a></li>
            <li><a href="#"><i class="fa fa-star-o"></i> Prestasi </a></li>
                ...
                <tbody>
          				<?php
          					...
          					foreach ($data->result_array() as $i) :
          					   ...
          					   $kategorii_id=$i['siswa_kategorii_id'];
                                          ...
                                          <select name="xkelas" class="form-control" required>
                                            ...
                                            <?php
                                                foreach ($kelas->result_array() as $k) {
                                                  $id_kelas=$k['kategorii_id'];
                                                  $nm_kelas=$k['kategorii_nama'];
