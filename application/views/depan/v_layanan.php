...
<html lang="en">
	<head>
		...
		<link rel="stylesheet" href="<?php echo site_url();?>css/list.css">
		<link rel="stylesheet" href="<?php echo site_url();?>css/style.css">
		<script src="<?php echo site_url();?>js/jquery.js"></script>
		<script src="<?php echo site_url();?>js/jquery-migrate-1.1.1.js"></script>
		<script src="<?php echo site_url();?>js/jquery.equalheights.js"></script>
		...
		<script src="<?php echo site_url();?>js/m.js"></script>
		<script>
...
<!--==============================header=================================-->
		<header>
			<a href="<?php echo site_url('home');?>"><img src="styles/images/logo1.jpg" style="width: 15%;margin:0 0 0 570px;"></a>
					...
					<div class="menu_block">
						<nav id="bt-menu" class="bt-menu">
							...
							<ul>
								...
								<li class="current bt-icon"><a href="index-2.html">Services</a></li>
...
<!--==============================Content=================================-->
		<div class="content cont1"><div class="ic">More Website Templates @ TemplateMonster.com - February 24, 2014!</div>
			<div class="container_12">
				<div class="grid_12">
		...
		<footer>
			<div class="container_12">
				<div class="grid_12">
					...
					<div class="clear"></div>
					<div class="copy">
						PT Tomo Teknologi Sinergi &copy; <script>document.write(new Date().getFullYear());</script> <a href="<?php echo base_url();?>" target="_blank"> | </a>
					</div>
				</div>
			</div>
		</footer>
